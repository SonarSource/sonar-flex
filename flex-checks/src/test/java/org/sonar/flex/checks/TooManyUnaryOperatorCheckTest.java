...
public class TooManyUnaryOperatorCheckTest {
  ...
  private TooManyUnaryOperatorCheck check = new TooManyUnaryOperatorCheck();

  @Test
  public void test() {
    SourceFile file = FlexAstScanner.scanSingleFile(new File("src/test/resources/checks/TooManyUnaryOperator.as"), check);
