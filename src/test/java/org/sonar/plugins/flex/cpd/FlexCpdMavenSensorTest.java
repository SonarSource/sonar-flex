...
public class FlexCpdMavenSensorTest {
  private Project project;
  private FlexCpdMavenSensor sensor;

  @Before
  public void setUp() {
    project = mock(Project.class);
    sensor = new FlexCpdMavenSensor(null);
  }

  @Test
  public void shouldReturnMavenPluginHandler() {
    FlexCpdMavenPluginHandler mavenPluginHandler = mock(FlexCpdMavenPluginHandler.class);
    sensor = new FlexCpdMavenSensor(mavenPluginHandler);
